  ...
  return (
    <div className="overflow-hidden rounded-component bg-[#f5f5f5] shadow-[0px_3px_9.7px_2px_rgba(0,0,0,0.12)]">
      ...
      <div className="px-5 py-4">
        <h3 className="text-[16px] font-semibold text-black tablet:text-[18px]">
          {title}
        </h3>
        <div className="mt-1 flex items-center gap-2 text-[13px] font-light text-gray-500 tablet:text-[14px]">
          <span>{year}</span>
          <span>|</span>
          <span>{km}</span>
        </div>
